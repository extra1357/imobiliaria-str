...
echo "🎨 Aplicando Layout Centralizado STR..."
echo ""

# Backup
cp src/app/admin/page.tsx src/app/admin/page.backup.tsx 2>/dev/null && echo "✓ Backup do dashboard criado"

# Criar novo dashboard (só conteúdo, sem sidebar)
...
echo "✓ Dashboard adaptado: src/app/admin/page.tsx"
echo ""
echo "══════════════════════════════════════════"
echo "✅ LAYOUT CENTRALIZADO APLICADO!"
echo "══════════════════════════════════════════"
echo ""
echo "Estrutura:"
echo "  layout.tsx → Sidebar + Header (compartilhado)"
echo "  page.tsx   → Só conteúdo (dashboard)"
echo ""
echo "Próximo passo:"
echo "  npm run dev"
