...
export const metadata: Metadata = {
  ...
  description: 'Encontre apartamentos e casas para alugar em Salto SP. Imóveis no Centro, Portal das Águas, Jardim Itália. Imobiliária especializada em Salto há mais de 10 anos.',
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="bg-blue-600 text-white p-8 rounded-lg text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            <a 
              href="https://wa.me/5511999999999?text=Olá! Gostaria de mais informações sobre imóveis em Salto"
              target="_blank"
